...
class sampleReadTrain_RGB(sampleRead):
  ...
  def initialize(self):
    ...
    self.width = 112
    self.path_to_images = RGB_frames 
    self.sample_list = '/home/shiyan/lisa-caffe-public-lstm_video_deploy/examples/LRCN_activity_recognition/5-cross/train1.txt' 
...
class sampleReadTest_RGB(sampleRead):
  ...
  def initialize(self):
    ...
    self.width = 112
    self.path_to_images = RGB_frames 
    self.sample_list = '/home/shiyan/lisa-caffe-public-lstm_video_deploy/examples/LRCN_activity_recognition/5-cross/test1.txt' 
