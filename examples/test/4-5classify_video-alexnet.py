...
cross = ['1','2','3','4','5']
for i in range(5):
	RGB_video_path = '/home/shiyan/lisa-caffe-public-lstm_video_deploy/examples/LRCN_activity_recognition/4-predict-5/'+cross[i]+'/'
	...
	RESULT_LABELS_PATH='./5-6model_four-'+cross[i]+'.txt'
